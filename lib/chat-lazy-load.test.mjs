...
test("treats only the real message tail as live-follow attached", async () => {
  ...
  assert.equal(isScrollAtTail(304, 600, 1000, CHAT_SCROLL_REATTACH_TOLERANCE), true);
  assert.equal(isScrollAtTail(303.99, 600, 1000, CHAT_SCROLL_REATTACH_TOLERANCE), false);
