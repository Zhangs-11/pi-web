...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.pinnedSessions": "置頂工作階段",
    "sidebar.pinSession": "置頂工作階段",
    "sidebar.unpinSession": "取消置頂",
    "sidebar.expandPinnedSessions": "展開置頂工作階段",
    "sidebar.collapsePinnedSessions": "摺疊置頂工作階段",
    "sidebar.pinnedSessionSettings": "置頂工作階段設定",
    "sidebar.collapsePinnedByDefault": "預設摺疊置頂工作階段",
