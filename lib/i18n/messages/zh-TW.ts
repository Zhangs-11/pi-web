...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.deleteSession": "將 {title} 移至回收桶？",
    "sidebar.rename": "重新命名",
    "sidebar.delete": "移至回收桶",
    "sidebar.deleteWithShiftClick": "移至回收桶（按住 Shift 點選可跳過確認）",
    "sidebar.trash": "回收桶",
    "trash.title": "回收桶",
    "trash.retentionNotice": "工作階段會在回收桶中保留 30 天。超過 30 天後，會在下次開啟或重新整理 Pi Web 時永久刪除。",
    "trash.loading": "正在載入回收桶…",
    "trash.empty": "目前專案的回收桶是空的",
    "trash.selectAll": "全選",
    "trash.selectSession": "選取 {title}",
    "trash.deletedAt": "刪除於 {date}",
    "trash.daysRemaining": "剩餘 {count} 天",
    "trash.oneDayRemaining": "剩餘 1 天",
    "trash.familySize": "包含 {count} 個相關工作階段",
    "trash.restore": "還原",
    "trash.restoring": "還原中…",
    "trash.selectedCount": "已選取 {count} 項",
    "trash.deletePermanently": "永久刪除",
    "trash.confirmPermanentDelete": "永久刪除選取的 {count} 個工作階段？此操作無法復原。",
    "trash.deleteNow": "立即刪除",
    "trash.deleting": "刪除中…",
