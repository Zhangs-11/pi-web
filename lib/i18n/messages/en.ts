...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.expandPinnedSessions": "Expand pinned sessions",
    "sidebar.collapsePinnedSessions": "Collapse pinned sessions",
    "sidebar.pinnedSessionSettings": "Pinned session settings",
    "sidebar.collapsePinnedByDefault": "Collapse pinned sessions by default",
