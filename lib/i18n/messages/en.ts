...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.deleteSession": "Move {title} to trash?",
    "sidebar.rename": "Rename",
    "sidebar.delete": "Move to trash",
    "sidebar.deleteWithShiftClick": "Move to trash (Shift+click to skip confirmation)",
    "sidebar.trash": "Trash",
    "trash.title": "Trash",
    "trash.retentionNotice": "Sessions stay here for 30 days. Expired sessions are permanently deleted the next time Pi Web is opened or refreshed.",
    "trash.loading": "Loading trash…",
    "trash.empty": "Trash is empty for this project",
    "trash.selectAll": "Select all",
    "trash.selectSession": "Select {title}",
    "trash.deletedAt": "Deleted {date}",
    "trash.daysRemaining": "{count} days remaining",
    "trash.oneDayRemaining": "1 day remaining",
    "trash.familySize": "{count} related sessions",
    "trash.restore": "Restore",
    "trash.restoring": "Restoring…",
    "trash.selectedCount": "{count} selected",
    "trash.deletePermanently": "Delete permanently",
    "trash.confirmPermanentDelete": "Permanently delete {count} selected sessions? This cannot be undone.",
    "trash.deleteNow": "Delete now",
