...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.deleteSession": "将 {title} 移入回收站？",
    "sidebar.rename": "重命名",
    "sidebar.delete": "移入回收站",
    "sidebar.deleteWithShiftClick": "移入回收站（按住 Shift 点击可跳过确认）",
    "sidebar.trash": "回收站",
    "trash.title": "回收站",
    "trash.retentionNotice": "会话将在回收站中保留 30 天。超过 30 天后，会在下次打开或刷新 Pi Web 时永久删除。",
    "trash.loading": "正在加载回收站…",
    "trash.empty": "当前项目的回收站为空",
    "trash.selectAll": "全选",
    "trash.selectSession": "选择 {title}",
    "trash.deletedAt": "删除于 {date}",
    "trash.daysRemaining": "剩余 {count} 天",
    "trash.oneDayRemaining": "剩余 1 天",
    "trash.familySize": "包含 {count} 个关联会话",
    "trash.restore": "恢复",
    "trash.restoring": "恢复中…",
    "trash.selectedCount": "已选择 {count} 项",
    "trash.deletePermanently": "永久删除",
    "trash.confirmPermanentDelete": "永久删除选中的 {count} 个会话？此操作无法撤销。",
    "trash.deleteNow": "立即删除",
    "trash.deleting": "删除中…",
