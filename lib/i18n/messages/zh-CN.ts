...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.pinnedSessions": "置顶会话",
    "sidebar.pinSession": "置顶会话",
    "sidebar.unpinSession": "取消置顶",
    "sidebar.expandPinnedSessions": "展开置顶会话",
    "sidebar.collapsePinnedSessions": "折叠置顶会话",
    "sidebar.pinnedSessionSettings": "置顶会话设置",
    "sidebar.collapsePinnedByDefault": "默认折叠置顶会话",
